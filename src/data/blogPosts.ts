...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    content: [
      ...
      'The economics work too. Platform builds start from $2,000 — every site custom-built from scratch, scoped to what you actually need. And my pricing is structured so my success is tied to yours: I stay as your long-term technical partner from $200/month, maintaining and evolving the platform as you grow. You get infrastructure from day one that would cost $15,000+ if you hired a dev shop later.',

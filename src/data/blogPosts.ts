...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    content: [
      ...
      'The economics work too. No upfront cost — every site custom-built from scratch, scoped to what you actually need. My pricing is structured so my success is tied to yours: I take a small % of revenue (5–15% based on what we build) only when you cross $5K/month. Below that threshold, you pay nothing. You get infrastructure from day one that would cost $15,000+ if you hired a dev shop later — and we both grow together.',

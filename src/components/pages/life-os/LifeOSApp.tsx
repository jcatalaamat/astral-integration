    ...
    >
      ...
      >
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          >
            <span style={{ color: tool.theme.primary }}>{tool.icon}</span>
            <span>{getGreeting()}</span>
            <span style={{ color: "#4a4860", fontSize: "14px" }}>·</span>
            <span style={{ color: "#6B6880", fontSize: isMobile ? "12px" : "14px" }}>{getToday()}</span>
          </div>
        </div>
      ...
      <div style={{ display: "flex", flex: 1, minHeight: 0, position: "relative" }}>
        ...
        >
          ...
          {/* Branding at bottom */}
          <div style={{ padding: "12px 20px", borderTop: "1px solid rgba(123,104,238,0.06)" }}>
        ...
        <div style={{ flex: 1, padding: isMobile ? "16px" : "24px", overflowY: "auto" }}>
          ...
          <div style={{ marginBottom: "24px" }}>
            ...
            >
              ...
              <h2 style={{ fontSize: isMobile ? "18px" : "20px", fontWeight: 400, margin: 0 }}>
                {activeCat.label}
              </h2>
          ...
          <div style={{ display: "flex", gap: "8px", marginBottom: "20px", flexWrap: "wrap" }}>
            <button
              onClick={() => {
                setShowCapture(true);
                setInputCategory(activeCategory);
              }}
              style={{
                background: "#111118",
            ...
            {activeItems.map((item) => (
              <div
                ...
                style={{
                  ...
                  border: `1px solid ${
                    item.priority && !item.done ? "rgba(201,169,110,0.15)" : "rgba(123,104,238,0.06)"
                  }`,
                  borderRadius: "10px",

...
export default function SchoolsPage() {
  useDocumentMeta({
    title: 'For schools — Astral Studio',
    description: 'I turn your curriculum into a school that runs itself. Cohorts, enrollment, member portal, certification tracking, and the AI trained on your curriculum.',
    ogUrl: 'https://astralstudio.io/schools',
  });
    ...
    <div className="min-h-screen bg-dark-bg font-sans">
      ...
      <section className="pt-40 pb-20 px-6 md:px-12">
        <div className="max-w-content mx-auto">
          ...
          <h1 className="font-serif text-display font-light mb-8 max-w-[800px]">
            I turn your curriculum into a <em className="italic gradient-text">school</em><br />that runs itself.
          </h1>
          <p className="text-body text-content-secondary max-w-prose">
            Cohorts, enrollment, member portal, certification tracking, and the AI trained on your curriculum. One platform, not seven.
          </p>
        </div>
      </section>
      ...
      <section className="py-section px-6 md:px-12 bg-bg-2">
        <div className="max-w-content mx-auto reveal" ref={addRevealRef}>
          ...
          <p className="text-body text-content-secondary max-w-prose mb-8">
            You own the code, the data, the student records. From day one.
          </p>
          <a

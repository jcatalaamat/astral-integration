export const careersContent = {
  ...
  whoWereLookingFor: {
    ...
    description: "We're interested in people who:",
    items: [
      'think in systems',
    ...
    note: 'If you need detailed instructions or constant feedback, this will not be a good fit.'
  },
  roles: [
    {
      title: 'Founding Operations & Systems Lead',
      type: 'COO-type role',
    ...
    {
      title: 'Founding Design / UX Lead',
      type: 'Part-time, systems-focused',
  ...
  howToReachOut: {
    headline: 'How to Reach Out',
    description: 'If one of the roles above feels aligned, contact us with:',
    items: [
      'a brief introduction',
      'relevant experience or examples',
      "the role you're interested in"
    ],
    note: 'We respond personally to aligned inquiries.'
  }
};
